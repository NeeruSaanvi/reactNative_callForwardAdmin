...
const mgiEnabled = process.env.REACT_APP_ENABLE_MGI !== 'false';
...
export const AdminPrivileges = mgiEnabled ? [
  ...
  Privileges.ReadSmsConnections, Privileges.WriteSmsConnections,
  Privileges.ReadIdRos, Privileges.WriteIdRos,
  Privileges.GeographicInformation,
  Privileges.LergImport, Privileges.ViewLerg,
  Privileges.ActivityLog,
  ...
  Privileges.ReadCompany, Privileges.WriteCompany,
  Privileges.LergImport, Privileges.ViewLerg,
  Privileges.ViewCDR, Privileges.ViewRate, Privileges.CDRImport, Privileges.RateImport, 
  Privileges.LCRReport, Privileges.CPRReport, Privileges.NewCPRReport
];

export const NMSPrivileges = mgiEnabled ? [
  Privileges.CustomerRecord, Privileges.PointerRecord, Privileges.TemplateAdmin, Privileges.RecordAdmin, Privileges.TemplateAdminData, Privileges.TemplateRecordList,
  Privileges.NumberSearch, Privileges.NumberList, Privileges.ReservationLimit, Privileges.ReservedNumberList, Privileges.NumberQueryUpdate, Privileges.NumberStatusChange,
