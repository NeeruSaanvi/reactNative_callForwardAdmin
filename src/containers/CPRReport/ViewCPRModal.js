...
import {formatCost} from "../../components/utiles";
          ...
          <Row>
            <Col lg="12" className="row mb-2">
              <Col lg="6" className="row">
                ...
                <Col lg="6">
                  <Input type="text" className="form-control-sm" value={formatCost(this.props.totalCost)}/>
                </Col>
              </Col>
              <Col lg="6" className="row">
                <Col lg="6" className="text-right">
                ...
                <Col lg="6">
                  <Input type="text" className="form-control-sm" value={formatCost(this.props.averageRate)}/>
                </Col>
              </Col>
              <Col lg="6" className="row mt-1">
                ...
                <Col lg="6">
                  <Input type="text" className="form-control-sm" value={this.props.defaultCarrier}/>
                </Col>
              </Col>
              <Col lg="6" className="row mt-1">
                <Col lg="6" className="text-right">
                ...
                <Col lg="6">
                  <Input type="text" className="form-control-sm" value={this.props.defaultCarrierNpaNxx}/>
                </Col>
              </Col>
            </Col>
            <Col lg="12">
