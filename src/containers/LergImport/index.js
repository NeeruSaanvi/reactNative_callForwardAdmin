...
class LergImport extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      state: "0", lata: "0", ocn: "0",npa: "0", nxx: "0", x: "0", carrier: "0", acna: "0", cic: "0", insert_type: 'overwrite',
      valid_state: false, valid_lata: false, valid_ocn: false, valid_npa: false, valid_nxx: false, valid_x: false, valid_carrier: false,
  ...
  parse_lerg = () => {
    ...
    else if (this.state.ocn === null) {this.setState({valid_ocn: true}); return false;}
              ...
              <Card>
                ...
                <CardBody>
                  <FormGroup row>
                    ...
                    {this.renderIndex("OCN:", 'ocn', this.state.valid_ocn)}
