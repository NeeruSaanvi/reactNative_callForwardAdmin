...
class RateImport extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ocn: null, lata: null, npa: null, nxx: null, npanxx: null, init_duration: "", increment_duration: "", inter_rate: null, intra_rate: null, default_rate: null,
              ...
              <Card>
                ...
                <CardBody>
                  <FormGroup row>
                    ...
                    <Col lg="4" className="row text-right">
                      <Col lg="5"><Label className="mt-4">Carrier CIC:</Label></Col>
                    ...
                    <Col lg="4" className="row text-right">
                      <Col lg="5">
                        <Label className="mt-4">Default rate:</Label>
                      </Col>
                      <Col lg="7">
                        <Input type="number" name="default_rate" className="form-control-sm mt-4" onChange={this.handleChange}/>
                      </Col>
                    </Col>
