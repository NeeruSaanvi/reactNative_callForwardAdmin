...
class EditUserModal extends Component {
    ...
    return (
      <Modal className="modal-xl" isOpen={this.props.isOpen}>
        ...
        <ModalBody>
          <Row>
            <Col xs="12" lg="6">
              <MainInfo data={user.main} company={this.props.company} hasFooter={this.props.hasFooter}
                inModal handleChange={this.handleChange('main')} handleRoleChange={this.handleRoleChange}
                handleCompanyChange={this.handleCompanyChange} isRoleEditable disabled={this.props.disabled}
                resetHandler={this.resetMainForm} updateHandler={this.updateMainForm} />
              <EditIP isSuperAdmin={this.props.isSuperAdmin} data={user.ips} hasFooter={this.props.hasFooter} inModal addIp={this.addIp} removeIp={this.removeIp} disabled={this.props.disabled} resetHandler={this.resetIPForm} updateHandler={this.updateIPForm} />
            </Col>
            <Col xs="12" lg="6">
  ...
  handleCompanyChange = (evt) => {
    this.props.handleCompanyChange(evt);
  };
